...
6. REJECT only for a Critical or High cost risk; APPROVE-WITH-NOTES while any Medium or Low cost concern stands or has been explicitly accepted; never APPROVE until there is nothing worth recording; NO-FINDINGS only when the change had no cost surface
