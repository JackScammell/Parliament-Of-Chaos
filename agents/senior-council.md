...
- **Conflict Resolution**: When reviewers disagree, apply priority: security > correctness > maintainability > performance > convenience. Out-of-scope recommendations: log to "Deferred" section, do not block approval. Present genuine trade-offs to user.
