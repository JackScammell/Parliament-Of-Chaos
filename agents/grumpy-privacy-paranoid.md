...
6. REJECT only for a Critical or High privacy risk; APPROVE-WITH-NOTES while any Medium or Low concern stands; never APPROVE until there is nothing worth recording; NO-FINDINGS only when no personal data was in scope
