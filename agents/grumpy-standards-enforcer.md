...
4. APPROVE only when all rules satisfied; REJECT otherwise; NO-FINDINGS when no violation was found at all
...
4. **Verdict** – APPROVE, REJECT (with path to compliance), or NO-FINDINGS
