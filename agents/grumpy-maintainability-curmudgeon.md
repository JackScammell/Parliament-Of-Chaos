...
4. **Verdict** – REJECT if maintainability is at Critical or High risk, APPROVE-WITH-NOTES with the Medium/Low debt recorded, APPROVE if maintainable, or NO-FINDINGS if nothing to report
